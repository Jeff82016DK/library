$(function () {
    ...
    newList = [
        ...
        { num: 1, img: "./poto/language/language_2-1.png", title: "英文自我介紹看完這本就能說!", money: "定價$420", hot_money: null, class: "language", class2: "love", publishing: "出版社:語研學院出版社", author: "作者:朴龍浩", publication_date: "出版日:2022/09/07", data_name: "language-2" },
        ...
        { num: 6, img: "./poto/love/love-3-1.png", title: "SKimmy的台北戀愛圖鑑", money: "定價$380", class: "love", class2: "language", publishing: "出版社:平裝本", author: "作者:Skimmy", publication_date: "出版日:2020/07/06", data_name: "love-3" },
        ...
        { num: 9, img: "./poto/literature/literatrue_2-1.png", title: "灰色人類", money: "定價$420", class: "literatrue", class2: "travel", publishing: "出版社:小異", author: "作者:金東植", publication_date: "出版日:2022/07/27", data_name: "literatrue-2" },
    ...
    $.each(newList, function (key, obj) {
        ...
        var $mypord = `<div class="${myclass} ${myclass2} ${data_Name}" data-name="${data_Name}">
            ...
            <ul>
                ...
                <p id = "pp">李大明:這本書好好看</p><span id = "sp">2022/10/27</span>
                <input id = "tt" type="text">
                <button id = "boo">送出</button>
                </div>`;
    ...
    // var btn = document.querySelector("#sur");
    // btn.addEventListener("click", (event) => {
    //     let checkboxes = document.querySelectorAll('input[name="mybox"]:checked');
    //     let values = [];
